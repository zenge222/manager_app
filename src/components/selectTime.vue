  ...
  <div class="selectTime has-header">
    ...
    <div class="tab_container time_select_box">
      ...
      <div class="footer_btns">
        <van-button @click="postData">提交</van-button>
        <van-button @click="reGet">重选</van-button>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      workIndex: state => state.appoint.workIndex,
      freeIndex: state => state.appoint.freeIndex,
